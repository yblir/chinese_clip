...
sys.path.append(r'E:\GitHub\chinese_clip')
...
def parse_args():
    ...
    parser.add_argument(
            ...
            help="The padded length of input text (include [CLS] & [SEP] tokens). Default to 52."
    )
...
if __name__ == '__main__':
    ...
    if args.convert_text:
        ...
        text_fp16_onnx_model = convert_float_to_float16(text_fp32_onnx_model, keep_io_types=True,
    ...
    if args.convert_vision:
        ...
        vision_fp16_onnx_model = convert_float_to_float16(vision_fp32_onnx_model, keep_io_types=True,
                                                          disable_shape_infer=True)
    ...
    if args.convert_text:
        ...
        print(
                f">>> The text FP16 ONNX model is saved at {text_fp16_onnx_path} with extra file {text_fp16_onnx_path}.extra_file")
    if args.convert_vision:
        ...
        print(
                f">>> The vision FP16 ONNX model is saved at {vision_fp16_onnx_path} with extra file {vision_fp16_onnx_path}.extra_file")
